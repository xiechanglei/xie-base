...
import io.github.xiechanglei.base.common.jpa.annotation.NoOverwrite;
import io.github.xiechanglei.base.common.jpa.exception.ForkNotExistsException;
...
public interface BaseEntity {
    ...
    default BaseEntity fork(JpaRepository<? extends BaseEntity, Object> repo) throws ForkNotExistsException {
        Object id = FieldHelper.getFiledValueByAnnotation(this.getClass(), Id.class);
        if (id == null) {
